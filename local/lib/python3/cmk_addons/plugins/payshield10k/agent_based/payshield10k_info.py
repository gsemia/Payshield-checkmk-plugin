...
# OIDs used:
# THALES-PAYSHIELD-MIB::payShieldSystemDateAndTime.0                                  .1.3.6.1.4.1.4096.2.2.10000.5.1.0 = Hex-STRING: 07 E4 0B 0D 0D 13 2D 00
# THALES-PAYSHIELD-MIB::payShieldSystemSerialNum.0                                    .1.3.6.1.4.1.4096.2.2.10000.5.2.0 = STRING: "S0246378732H"
# THALES-PAYSHIELD-MIB::payShieldSystemModel.0                                        .1.3.6.1.4.1.4096.2.2.10000.5.3.0 = STRING: "PS10-S"
# THALES-PAYSHIELD-MIB::payShieldFraudPinVerifyLimitsExceeded.0                       .1.3.6.1.4.1.4096.2.2.10000.6.1.0 = INTEGER: 2
# THALES-PAYSHIELD-MIB::payShieldFraudPinAttackLimitsExceeded.0                       .1.3.6.1.4.1.4096.2.2.10000.6.2.0 = INTEGER: 2
# THALES-PAYSHIELD-MIB::payShieldVersionSoftwareBaseRelease.0                         .1.3.6.1.4.1.4096.2.2.10000.7.1.0 = STRING: "1.0f"
# THALES-PAYSHIELD-MIB::payShieldVersionSoftwareRevision.0                            .1.3.6.1.4.1.4096.2.2.10000.7.2.0 = STRING: "1500-1022"
# THALES-PAYSHIELD-MIB::payShieldVersionSoftwareBuildNumber.0                         .1.3.6.1.4.1.4096.2.2.10000.7.3.0 = STRING: "0000"
# THALES-PAYSHIELD-MIB::payShieldVersionSoftwareHSMCoreAPIVersion.0          			.1.3.6.1.4.1.4096.2.2.10000.7.4.0 = ""
# THALES-PAYSHIELD-MIB::payShieldVersionSoftwareCPLDVersion.0                         .1.3.6.1.4.1.4096.2.2.10000.7.5.0 = STRING: "1.2.3"
# THALES-PAYSHIELD-MIB::payShieldVersionSoftwareSPVersion.0                           .1.3.6.1.4.1.4096.2.2.10000.7.6.0 = STRING: "1.1.29"
# THALES-PAYSHIELD-MIB::payShieldVersionSoftwareSPBootVersion.0                       .1.3.6.1.4.1.4096.2.2.10000.7.7.0 = STRING: "1.0.0"
# THALES-PAYSHIELD-MIB::payShieldVersionSoftwareBootstrapVersion.0            		.1.3.6.1.4.1.4096.2.2.10000.7.8.0 = STRING: "1.1.40"
# THALES-PAYSHIELD-MIB::payShieldVersionSoftwareFirmwareVersion.0                     .1.3.6.1.4.1.4096.2.2.10000.7.9.0 = STRING: "1.3.1"
# THALES-PAYSHIELD-MIB::payShieldVersionSoftwareDeploymentVersion.0           		.1.3.6.1.4.1.4096.2.2.10000.7.10.0 = STRING: "1.3.2"
# THALES-PAYSHIELD-MIB::payShieldLicensingPerformanceModel.0                          .1.3.6.1.4.1.4096.2.2.10000.8.1.0 = INTEGER: 25
# THALES-PAYSHIELD-MIB::payShieldLicensingPackage.0                                   .1.3.6.1.4.1.4096.2.2.10000.8.2.0 = STRING: "Premium Package:Premium Key Management;Magnetic Stripe Issuing;Magnetic Stripe Transaction Processing;EMV Chip, Contactless & Mobile Issuing;EMV Transaction Processing;User Authentication;Data Protection;"
# THALES-PAYSHIELD-MIB::payShieldLicensingOptionalLicenseCount.0                      .1.3.6.1.4.1.4096.2.2.10000.8.3.0 = INTEGER: 1
